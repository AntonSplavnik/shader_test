...
void    main_loop(void *param)
{
    ...
    mouse_x_norm = mouse_x / (float)gl_init->win_width;
    mouse_y_norm = mouse_y / (float)gl_init->win_height;
    ...
    glUniform2f(loc_resolution, (float)gl_init->win_width, (float)gl_init->win_height);
